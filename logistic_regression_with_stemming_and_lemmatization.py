...
# Пример
predict_trump_quote("We will make America great again.") # 0.91 > 0.90
predict_trump_quote("Fuck Hillary") # 0.68 < 0.71
predict_trump_quote("We have the most smart people.") # 0.83 > 0.77

predict_trump_quote("To be or not to be.") # 0.13 < 0.22
